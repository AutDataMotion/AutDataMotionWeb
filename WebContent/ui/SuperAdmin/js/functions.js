		...
		.ready(
				function() {
					...
					var settings = '<a id="settings" href="#changeSkin" data-toggle="modal">'
							...
							+ '<img src="/ui/SuperAdmin/img/skin-violate.jpg" alt="">'
							+ '</a>'
							+ '<a data-skin="skin-blur-lights" class="col-sm-2 col-xs-4" href="">'
							+ '<img src="/ui/SuperAdmin/img/skin-lights.jpg" alt="">'
							+ '</a>'
							+ '<a data-skin="skin-blur-city" class="col-sm-2 col-xs-4" href="">'
							+ '<img src="/ui/SuperAdmin/img/skin-city.jpg" alt="">'
							+ '</a>'
							+ '<a data-skin="skin-blur-greenish" class="col-sm-2 col-xs-4" href="">'
							+ '<img src="/ui/SuperAdmin/img/skin-greenish.jpg" alt="">'
							+ '</a>'
							+ '<a data-skin="skin-blur-night" class="col-sm-2 col-xs-4" href="">'
							+ '<img src="/ui/SuperAdmin/img/skin-night.jpg" alt="">'
							+ '</a>'
							+ '<a data-skin="skin-blur-blue" class="col-sm-2 col-xs-4" href="">'
							+ '<img src="/ui/SuperAdmin/img/skin-blue.jpg" alt="">'
							+ '</a>'
							+ '<a data-skin="skin-blur-sunny" class="col-sm-2 col-xs-4" href="">'
							+ '<img src="/ui/SuperAdmin/img/skin-sunny.jpg" alt="">'
							+ '</a>'
							+ '<a data-skin="skin-cloth" class="col-sm-2 col-xs-4" href="">'
							+ '<img src="/ui/SuperAdmin/img/skin-cloth.jpg" alt="">'
							+ '</a>'
							+ '<a data-skin="skin-tectile" class="col-sm-2 col-xs-4" href="">'
							+ '<img src="/ui/SuperAdmin/img/skin-tectile.jpg" alt="">'
							+ '</a>'
							+ '<a data-skin="skin-blur-chrome" class="col-sm-2 col-xs-4" href="">'
							+ '<img src="/ui/SuperAdmin/img/skin-chrome.jpg" alt="">'
							+ '</a>'
							+ '<a data-skin="skin-blur-ocean" class="col-sm-2 col-xs-4" href="">'
							+ '<img src="/ui/SuperAdmin/img/skin-ocean.jpg" alt="">'
							+ '</a>'
							+ '<a data-skin="skin-blur-sunset" class="col-sm-2 col-xs-4" href="">'
							+ '<img src="/ui/SuperAdmin/img/skin-sunset.jpg" alt="">'
							+ '</a>'
							+ '<a data-skin="skin-blur-yellow" class="col-sm-2 col-xs-4" href="">'
							+ '<img src="/ui/SuperAdmin/img/skin-yellow.jpg" alt="">'
							+ '</a>'
							+ '<a  data-skin="skin-sky1"class="col-sm-2 col-xs-4" href="">'
							+ '<img src="/ui/SuperAdmin/img/skin-sky1.png" alt="">'
							+ '</a>'
							+ '<a  data-skin="skin-2"class="col-sm-2 col-xs-4" href="">'
							+ '<img src="/ui/SuperAdmin/img/skin-2.png" alt="">'
							+ '</a>'
							+ '<a  data-skin="skin-3"class="col-sm-2 col-xs-4" href="">'
							+ '<img src="/ui/SuperAdmin/img/skin-3.png" alt="">'
							+ '</a>'
							+ '<a  data-skin="skin-4"class="col-sm-2 col-xs-4" href="">'
							+ '<img src="/ui/SuperAdmin/img/skin-4.png" alt="">'
							+ '</a>'
							+ '<a  data-skin="skin-5"class="col-sm-2 col-xs-4" href="">'
							+ '<img src="/ui/SuperAdmin/img/skin-5.png" alt="">'
							+ '</a>'
							+ '<a  data-skin="skin-6"class="col-sm-2 col-xs-4" href="">'
							+ '<img src="/ui/SuperAdmin/img/skin-6.png" alt="">'
							+ '</a>'
							+ '<a  data-skin="skin-7"class="col-sm-2 col-xs-4" href="">'
							+ '<img src="/ui/SuperAdmin/img/skin-7.png" alt="">'
							+ '</a>'
							+ '<a  data-skin="skin-8"class="col-sm-2 col-xs-4" href="">'
							+ '<img src="/ui/SuperAdmin/img/skin-8.png" alt="">'
							+ '</a>'
							+ '<a  data-skin="skin-9"class="col-sm-2 col-xs-4" href="">'
							+ '<img src="/ui/SuperAdmin/img/skin-9.png" alt="">'
							+ '</a>'
		
							+ '<a  data-skin="skin-11"class="col-sm-2 col-xs-4" href="">'
							+ '<img src="/ui/SuperAdmin/img/skin-11.png" alt="">'
							+ '</a>'
							+ '<a  data-skin="skin-12"class="col-sm-2 col-xs-4" href="">'
							+ '<img src="/ui/SuperAdmin/img/skin-12.png" alt="">'
							+ '</a>'
							+ '<a  data-skin="skin-13"class="col-sm-2 col-xs-4" href="">'
							+ '<img src="/ui/SuperAdmin/img/skin-13.png" alt="">'
							+ '</a>'
							+ '<a  data-skin="skin-14"class="col-sm-2 col-xs-4" href="">'
							+ '<img src="/ui/SuperAdmin/img/skin-14.png" alt="">'
							+ '</a>'
							+ '<a  data-skin="skin-15"class="col-sm-2 col-xs-4" href="">'
							+ '<img src="/ui/SuperAdmin/img/skin-15.png" alt="">'
							+ '</a>'
					...
					(function() {
						/* Menu Toggle */
						$('body').on('click touchstart', '#menu-toggle',
								function(e) {
									e.preventDefault();
					...
					(function() {
						$('body').on(
								'click touchstart',
								'.tile .tile-info-toggle',
								function(e) {
									e.preventDefault();
									$(this).closest('.tile')
											.find('.chart-info').toggle();
								});
					})();
					...
					(function() {
						setTimeout(function() {
							...
							$('.todo-list .media .checked').each(
									function() {
										$(this).closest('.media').find(
												'.checkbox label').css(
												'text-decoration',
												'line-through')
									});
					...
					(function() {
						...
						$('body').on(
								...
								'.drawer-close',
								function() {
									$(this).closest('.drawer').removeClass(
											'toggled');
									$('.drawer-toggle').removeClass('open');
								});
					})();
					...
					$(function() {
						$('body').on(
								...
								'.chat-list-toggle',
								function() {
									$(this).closest('.chat').find('.chat-list')
											.toggleClass('toggled');
								});
					...
					(function() {
						...
						if ($('[class*="color-picker"]')[0]) {
							$('[class*="color-picker"]').colorpicker().on(
									'changeColor',
									function(e) {
										var colorThis = $(this).val();
										$(this).closest('.color-pick').find(
												'.color-preview').css(
					...
					(function() {
						...
						$('.datetime-pick input:text').on(
								'click',
								function() {
									$(this).closest('.datetime-pick').find(
											'.add-on i').click();
								});
					})();
					...
					(function() {
						if ($('.pirobox_gall')[0]) {
							...
							$().piroBox_ext({
								...
								bg_alpha : 0.5,
								piro_scroll : true
							// pirobox always positioned at the center of the
							// page
							});
						}
					})();
					...
					(function() {
						$('.tab-vertical').each(
								function() {
									...
									var tabContentHeight = $(this).closest(
											'.tab-container').find(
					...
					(function() {
						$('body').on(
								...
								function(e) {
									...
									$(this).closest('.box').toggleClass(
											'active');
									$('#' + box).closest('.box').addClass(
											'active');
								});
					})();
					...
					if ($('input:checkbox, input:radio')[0]) {
						...
						parentCheck.on('ifChecked', function() {
							$(this).closest('.list-container').find(
						...
						listCheck.on('ifChecked', function() {
							...
							var thisCheck = $(this).closest('.list-container')
									.find('.list-check');
							var thisChecked = $(this)
									.closest('.list-container').find(
											'.list-check:checked');
						...
						listCheck.on('ifChanged', function() {
							var thisChecked = $(this)
									.closest('.list-container').find(
											'.list-check:checked');
							var showon = $(this).closest('.list-container')
									.find('.show-on');
							...
							someValue : 0
								...
								},
								{
									...
									step : function() { // called on every step
										// Update the element's text with
										// rounded-up value:
										target.text(commaSeparateNumber(Math
