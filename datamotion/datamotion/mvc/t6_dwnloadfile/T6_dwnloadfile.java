...
//@Table(tableName = "t6_dwnloadfile")
public class T6_dwnloadfile extends BaseModel<T6_dwnloadfile> implements InfMdlCom{

	private static final long serialVersionUID = 6761767368352810428L;

	private static Logger log = Logger.getLogger(T6_dwnloadfile.class);
	
	public static final T6_dwnloadfile dao = new T6_dwnloadfile();
	...
	/**
	 * sqlId : datamotion.t6_dwnloadfile.splitPageFrom
	 * 描述：分页from
	 */
	public static final String sqlId_splitPage_from = "datamotion.t6_dwnloadfile.splitPageFrom";
